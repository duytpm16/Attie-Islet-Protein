...
input.dir <- '/Users/phamd/Desktop/pQTL_Project/data/islet_proteins_qtl/Dans_Attie_Scan1_normalized_chunks'  
output.prefix <- "attie_islet_proteins"
pheno.dict <- read.delim("~/Desktop/pQTL_Project/data/islet_proteins_pheno_dict.txt")
