...
load("~/Desktop/Attie Final/Islet Mediation/Protein 284/attie_islet_protein_284_qtl2_input.RData")
lod.peaks <- readRDS("~/Desktop/Attie Final/Islet Mediation/Protein 284/Additive/attie_islet_protein_284_rZ_lodpeaks_6.rds") # 8913 x 13
...
norm <- norm[,grep('ENSMUSP', colnames(norm))]       # 373 x 5469 -> 373 x 4859
rankz <- rankz[,grep('ENSMUSP', colnames(rankz))]    # 373 x 5469 -> 373 x 4859
...
lod.peaks <- lod.peaks[grep('ENSMUSP', lod.peaks$annot.id),]     # 8913 x 13   ->  7852 x 13
...
expr.annots <- expr.annots[expr.annots$protein_id %in% colnames(norm), ]   # 7160 x 11 -> 4859 x 11
...
save.image("~/Desktop/Attie Final/Islet Mediation/Protein 284/attie_islet_protein_284_rZ_qtl_viewer.RData")
