...
#
### Input:
#     1.) raw Attie cecum metabolite file: FilterdbyR_DOCecumMetbolites_BatchandCovariatesAppended.txt
...
### Remove other data
rm(chr_m_y,data.cb,mod,pc.data,batch,chg,dupl,i,rankZ,
