...
### Variables to change 
prefix <- "attie_islet_protein"                            # Prefix of the new raw, normalized, rank Z normalized, and samples rds file
pheno.dict <- read.delim("islet_proteins_pheno_dict.txt")  # Phenotype data dictionary
