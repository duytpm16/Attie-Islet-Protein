...
#     samples: 500 x 7
#     chr: 498 x 5
raw <- read.table("~/Desktop/pQTL_Project/data/DO_islet_proteomics_non_normalized.txt", sep = '\t', header = TRUE)
samples <- read.table("~/Desktop/pQTL_Project/data/attie_DO_sample_annot.txt", header = TRUE ,sep = "\t")
chr_m_y <- read.csv("~/Desktop/pQTL_Project/data/attie_sample_info_ChrM_Y.csv") 
raw_file <- "attie_islet_protein_filtered_raw.rds"
norm_file <- "attie_islet_protein_normalized.rds"
norm_rz_file <- "attie_islet_protein_rZ_normalized.rds"
samples_file <-  "attie_islet_protein_samples_annot.rds"
